...
export const metadata = {
  ...
  description: "Formation 04 King Rare checklist, rarity breakdown, premium cards, market highlights, and related guides."
};
...
export default async function Formation04Page() {
  ...
  return <SetGuide setCode="F04" setName="One Piece AR Carddass Formation 04" cards={getCoreKingRareCards(cards).filter((card) => getSetCode(card.cardNumber) === "F04")} relatedPosts={posts} />;
}
