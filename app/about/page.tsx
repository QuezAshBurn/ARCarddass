export default function AboutPage() {
  return (
    <section className="reading-shell section">
      <div className="methodology-surface content-card">
        ...
        <p>
          The site does not reproduce official logos as branding and does not
          imply endorsement by Bandai, Shueisha, Toei Animation, Fuji Television,
          or the rights holders of ONE PIECE.
        </p>
      </div>
    </section>
  );
